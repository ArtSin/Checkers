...
{
    class NegaScoutTranspositionBotClient : BotClient
    {
        ...
        public NegaScoutTranspositionBotClient(int moveDelay, ulong seed, int maxDepth) : base(moveDelay, seed)
        {
        ...
        {
            Move maxMove = null;
            transpositionTable = new Dictionary<(ulong, uint), TableEntry>();
            NegaScoutTransposition(Color, maxDepth, -INF, INF, ref maxMove);
            return maxMove;
        }
